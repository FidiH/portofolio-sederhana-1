  ...
  <div class="container mx-auto flex px-5 py-12 items-center justify-center flex-col">
    <div class="lg:w-2/3 w-full animate-fade-in-down">
      ...
      <p class="mt-8 mb-16 md:leading-relaxed leading-normal text-white tracking-tight text-xl">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam dolor consectetur quod esse consequatur laborum deleniti minus ducimus, aut doloribus neque, sunt veniam voluptatibus numquam iste beatae velit accusamus officiis!</p>
